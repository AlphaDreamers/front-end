...
export default function TermsOfService() {
  return (
    <PageTemplate
      ...
      description="Terms of Service for BlueFrog, a Solana-based freelance marketplace platform."
    >
      <main className="space-y-8">
        ...
        <section>
          ...
          <p className="text-base text-gray-200 leading-relaxed">
            ...
            marketplace platform. By accessing or using our services, you agree
            to be bound by these Terms of Service. If you disagree with any part
            of the terms, you may not access the service. BlueFrog reserves the
        ...
        <section>
          ...
          <p className="text-base text-gray-200 leading-relaxed">
            ...
            transactions initiated on BlueFrog. Sellers must deliver services as
            described and within the agreed timeframe. Buyers must provide clear
            requirements and compensate sellers as agreed. BlueFrog facilitates
            these transactions but is not responsible for the quality, safety,
            or legality of services offered. All service descriptions must be
            accurate and complete. Misrepresentation may result in account
            suspension.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-base text-gray-200 leading-relaxed">
            ...
            automatically. Users are responsible for any blockchain transaction
            fees. Payouts to sellers are processed within 24 hours of service
            acceptance. All transactions are final and recorded on the Solana
            blockchain. Users are responsible for their tax obligations related
        ...
        <section>
          ...
          <p className="text-base text-gray-200 leading-relaxed">
            ...
            and make a determination based on platform policies and transaction
            history. For unresolved disputes, users may escalate to arbitration
            as outlined in our Dispute Resolution Policy. BlueFrog&apos;s
            decision is final in matters related to platform usage and fund
            distribution.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-base text-gray-200 leading-relaxed">
            Accounts may be terminated for violations of these terms, fraudulent
            activity, or prolonged inactivity. BlueFrog reserves the right to
            suspend or terminate accounts at our discretion. Upon termination,
            your right to use the service will cease immediately. All provisions
        ...
        <section>
          ...
          <p className="text-base text-gray-200 leading-relaxed">
            ...
            . Our support team is available to address your concerns and provide
            guidance on platform usage. For urgent matters, please include
            &ldquo;URGENT&ldquo; in your email subject line.
          </p>
        </section>
      </main>
