...
import { getOrdersReport, downloadOrdersReportPDF } from '@/lib/actions/report';
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto space-y-6">
            ...
            {!reportData && !loading && (
                <Card>
                    <CardContent className="p-8 text-center">
                        <p className="text-gray-500">Apply filters and generate a report to view order details.</p>
                    </CardContent>
                </Card>
            )}
        </div>
