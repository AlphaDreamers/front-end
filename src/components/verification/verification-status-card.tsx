...
import { confirmFullProfileVerification } from "@/lib/actions/badges";
...
export function VerificationStatusCard({
  ...
  const handleApplyForFullVerification = async () =>
    toast.promise(
      async () => {
        const res = await confirmFullProfileVerification();
        if (res.success === false) {
          throw new Error(res.error || "Failed to apply for verification");
        }
      },
      {
