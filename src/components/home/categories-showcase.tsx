...
export function CategoriesShowcase({ getCategories }: CategoriesShowcaseProps) {
  return (
    <section>
      ...
      <div className="grid gap-2 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 auto-rows-[1fr]">
              ...
              return (
                ...
                >
                  <div className="flex flex-col items-center justify-center p-2.5 text-center">
                    <div
                      className={cn("mb-2 rounded-full p-4", {
                    ...
                    >
                      <IconComponent className="size-8 stroke-[1.25]" />
                    </div>
