...
const WelcomeEmailTemplate: React.FC = () => {
  return (
    <div
      style={{
        ...
        <tr>
          <td style={{ padding: "40px 30px" }}>
            ...
            >
              ...
              marketplace! Your account is active and ready to explore our
              vibrant community.
            </p>
            <div
              style={{
            ...
            >
              ...
              <div style={{ marginBottom: "16px" }}>
                <a
                  href={`${process.env.NEXT_PUBLIC_APP_URL}/gigs`}
                  style={{
                    display: "flex",
                    alignItems: "center",
                    color: "#6b7280",
              ...
              <div>
                <a
                  href={`${process.env.NEXT_PUBLIC_APP_URL}/dashboard/gigs/create`}
                  style={{
                    display: "flex",
                    alignItems: "center",
                    color: "#6b7280",
