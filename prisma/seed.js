    ...
    try {
        ...
        const faqs = [
            {
                ...
                answer: "Click the 'Connect Wallet' button in the navigation bar and select your preferred wallet (Phantom, Solflare, etc.). Approve the connection request in your wallet.",
            },
            {
                question: "What are the platform fees?",
                answer: "We charge a 10% service fee on completed orders. Sellers receive 90% of the order value. There are no listing fees or monthly charges.",
            },
            {
                question: "How does escrow work?",
                answer: "When you place an order, your payment is held in a secure smart contract. Funds are released to the seller only after you approve the delivered work.",
            },
            {
                question: "What if I'm not satisfied with the work?",
                answer: "You can request revisions based on the package you purchased. If issues persist, you can open a dispute and our team will help resolve it fairly.",
            },
            {
                question: "How long does seller verification take?",
                answer: "Verification typically takes 24-48 hours. We review your identity documents and may request additional information if needed.",
            },
        ];
        ...
        const sellerProfiles = [
            {
                ...
                skills: await Promise.all([
                    ...
                    "PostgreSQL",
                    "Git",
                ].map((title) => prisma.skill.create({ data: { title } }))).then((skills) => skills.map((skill) => skill.title)),
            },
            {
                ...
                avatar: avatarUrls[1],
                skills: await Promise.all(["Solana", "Rust", "Smart Contracts", "Web3", "Anchor", "DeFi"].map((title) => prisma.skill.create({ data: { title } }))).then((skills) => skills.map((skill) => skill.title)),
            },
            {
                ...
                avatar: avatarUrls[2],
                skills: await Promise.all(["UI Design", "UX Design", "Figma", "Tailwind CSS", "HTML/CSS"].map((title) => prisma.skill.create({ data: { title } }))).then((skills) => skills.map((skill) => skill.title)),
            },
            {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            const seller = await prisma.user.create({
                data: Object.assign(Object.assign({}, profile), { skills: undefined, password: hashedPassword, emailVerified: new Date(), banner: imageUrls[i], isKycVerified: true, isProfileVerified: true, country: "United States", languages: ["English"] }),
            });
            sellers.push(seller);
            users.push(seller);
        }
        ...
        for (const seller of sellers) {
            ...
            for (let i = 0; i < itemCount; i++) {
                await prisma.portfolioItem.create({
                    data: {
                        title: faker.helpers.fake("{{commerce.productAdjective}} {{commerce.product}} Project"),
            ...
            alex_webdev: [
                {
                    ...
                    description: "Get a professional, responsive website built with React and Next.js. Perfect for startups and small businesses looking for a modern web presence.",
                    ...
                    faqs: [
                        {
                            ...
                            answer: "I can help you deploy to Vercel, Netlify, or your preferred platform.",
                        },
                        {
                            question: "Can you integrate a CMS?",
                            answer: "Yes, I can integrate Contentful, Strapi, or any headless CMS.",
                        },
                    ],
                },
                {
                    title: "I Will Create a Full Stack Web Application",
                    description: "Need a complete web application? I'll build your frontend and backend with React, Node.js, and PostgreSQL.",
                    category: "Web Development",
                    ...
                    faqs: [
                        {
                            ...
                            answer: "RESTful API with Node.js, Express, and PostgreSQL database.",
                        },
                        {
            ...
            sarah_blockchain: [
                {
                    ...
                    description: "Professional Solana smart contract development using Rust and Anchor framework. Security-first approach with thorough testing.",
                    ...
                    faqs: [
                        {
                            ...
                            answer: "Basic security review is included. Full audit available as an add-on.",
                        },
                        {
                ...
                },
                {
                    ...
                    description: "Complete NFT minting solution on Solana. Includes smart contract, minting website, and Candy Machine setup.",
                    category: "Blockchain & Crypto",
                    ...
                    faqs: [
                        ...
                        },
                        {
                            ...
                            answer: "I focus on the technical side but can recommend artists.",
                        },
                    ],
                },
            ],
            maria_designer: [
                {
                    ...
                    description: "Professional UI/UX design for your web application. User-centered design approach with modern aesthetics.",
                    ...
                    faqs: [
                        ...
                        },
                        {
                            ...
                            answer: "Yes, you'll receive the complete Figma file with full editing rights.",
                        },
                    ],
                },
                {
                    ...
                    faqs: [
                        {
                            ...
                            answer: "3 initial concepts with unlimited revisions on the chosen one.",
                        },
                        {
            ...
            john_content: [
                {
                    ...
                    description: "Clear, comprehensive technical documentation for your software project. Developer-friendly and user-focused.",
                    ...
                    faqs: [
                        ...
                        },
                        {
                            ...
                            answer: "Yes, I create flowcharts and architecture diagrams as needed.",
                        },
                    ],
                },
                {
                    title: "I Will Write SEO-Optimized Blog Posts",
                    description: "Engaging, well-researched blog posts optimized for search engines. Perfect for tech companies and startups.",
                    category: "Content Writing",
                    ...
                    faqs: [
                        {
                            ...
                            answer: "Typically 1000-2000 words, but can be adjusted to your needs.",
                        },
                        {
                            question: "Do you include images?",
                            answer: "I can source royalty-free images or work with your provided images.",
                        },
                    ],
                },
            ],
            emma_marketing: [
                {
                    ...
                    description: "Comprehensive digital marketing strategy tailored to your business goals. Data-driven approach with actionable insights.",
                    ...
                    faqs: [
                        {
                            ...
                            answer: "SEO, content marketing, social media, email, and paid advertising.",
                        },
                        {
                            question: "Do you implement the strategy?",
                            answer: "This gig covers strategy. Implementation available separately.",
                        },
                    ],
                },
                {
                    title: "I Will Optimize Your Website for SEO",
                    description: "Complete SEO audit and optimization to improve your search rankings. Technical and content optimization included.",
                    category: "Digital Marketing",
                    ...
                    faqs: [
                        {
                            ...
                            answer: "SEO typically takes 3-6 months, but you'll see improvements starting month 1.",
                        },
                        {
                            question: "Do you work with all platforms?",
                            answer: "Yes, I work with WordPress, custom sites, and all major platforms.",
                        },
                    ],
                },
            ],
        ...
        for (const seller of sellers) {
            const templates = gigTemplates[seller.username] || [];
            for (const template of templates) {
                const category = createdCategories.find((c) => c.title === template.category);
                const gigTags = createdTags.filter((tag) => template.tags.includes(tag.title));
                ...
                for (const pkg of gig.packages) {
                    ...
                    for (let i = 0; i < gig.features.length; i++) {
                        ...
                        const isIncluded = packageIndex === 0 ? i < 2 : packageIndex === 1 ? i < 4 : true;
        ...
        let reviewCount = 0;
        const completedOrders = orders.filter((o) => o.status === "COMPLETED" && o.completedAt && o.completedAt < new Date());
        const reviewTemplates = {
            5: [
                {
                    title: "Excellent work!",
                    description: "Delivered exactly what I needed. Fast communication and professional service. Highly recommended!",
                },
                {
                    title: "Outstanding service",
                    description: "Went above and beyond my expectations. Will definitely work with them again.",
                },
                {
                    title: "Perfect!",
                    description: "Amazing quality and super fast delivery. Couldn't ask for better service.",
                },
                {
                    title: "Highly professional",
                    description: "Great communication throughout the project. Delivered on time with excellent quality.",
                },
            ],
            4: [
                {
                    title: "Very good",
                    description: "Good work overall. Minor revisions needed but seller was responsive and fixed everything quickly.",
                },
                {
                    title: "Great service",
                    description: "Delivered as promised. Good communication and quality work.",
                },
            ],
            3: [
                {
                    title: "Decent work",
                    description: "Got the job done but took longer than expected. Final result was acceptable.",
                },
            ],
        };
        ...
        for (const order of orders.slice(-50)) {
            ...
            if (order.status !== "PENDING_PAYMENT") {
                const metadata = {
                    ...
                    orderId: order.id,
                    status: order.status,
                    message: `New order received from ${(_a = buyers.find((b) => b.id === order.buyerId)) === null || _a === void 0 ? void 0 : _a.firstName}`,
                };
        ...
        sellers.forEach((seller, index) => {
            console.log(`   ${index + 1}. ${seller.username} (${seller.email}) - Wallet: ${SELLER_WALLETS[index]}`);
        });
    }
    catch (error) {
